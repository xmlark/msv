/*
 * @(#)DoubleValueType.java	1.63 00/02/02
 *
...
/**
 * The DoubleValueType class wraps a value of the primitive type
 * <code>double</code> in an object. An object of type
 * <code>DoubleValueType</code> contains a single field whose type is
 * <code>double</code>.
 * <p>
 ...
 * @since   JDK1.0
 */
public final class DoubleValueType extends Number implements Comparable {
    /**
     * The positive infinity of type <code>double</code>. It is equal to
     * the value returned by 
     * <code>DoubleValueType.longBitsToDouble(0x7ff0000000000000L)</code>.
     */
     ...
     * the value returned by 
     * <code>DoubleValueType.longBitsToDouble(0xfff0000000000000L)</code>. 
     */
     ...
     * the value returned by 
     * <code>DoubleValueType.longBitsToDouble(0x7ff8000000000000L)</code>.
     */
     ...
     * <blockquote><pre>
     * <code>DoubleValueType.longBitsToDouble(0x7fefffffffffffffL)</code>
     * </pre></blockquote>
     */
     ...
     * <code>DoubleValueType.longBitsToDouble(0x1L)</code>. 
     */
//  public static final double MIN_VALUE = 4.94065645841246544e-324;
    ...
    /**
     * Returns a new <code>DoubleValueType</code> object initialized to the value 
     ...
     * <code>DoubleValueType</code> object representing that value is created and 
     * returned. 
     * <p>
     ...
     * arithmetic. Finally, a new object of class <code>DoubleValueType</code> is 
     * created to represent the <code>double</code> value. 
     *
     * @param      s   the string to be parsed.
     * @return     a newly constructed <code>DoubleValueType</code> initialized to the
     *             value represented by the string argument.
     * @exception  NumberFormatException  if the string does not contain a
     *               parsable number.
     */
    public static DoubleValueType valueOf(String s) throws NumberFormatException {
	return new DoubleValueType(FloatingDecimal.readJavaFormatString(s).doubleValue());
    }

    /**
     * Returns a new double initialized to the value represented by the 
     * specified <code>String</code>, as performed by the <code>valueOf</code>
     * method of class <code>DoubleValueType</code>.
     *
     * @param      s   the string to be parsed.
     * @return     the double value represented by the string argument.
     * @exception  NumberFormatException  if the string does not contain a
     *               parsable double.
     * @see        java.lang.DoubleValueType#valueOf(String)
     * @since      1.2
     */
    ...
    /**
     * The value of the DoubleValueType.
     *
     * @serial
     */
    ...
    /**
     * Constructs a newly allocated <code>DoubleValueType</code> object that
     * represents the primitive <code>double</code> argument.
     *
     * @param   value   the value to be represented by the <code>DoubleValueType</code>.
     */
     ...
     *
     * @param      s   a string to be converted to a <code>DoubleValueType</code>.
     * @exception  NumberFormatException  if the string does not contain a
     *               parsable number.
     * @see        java.lang.DoubleValueType#valueOf(java.lang.String)
     */
    public DoubleValueType(String s) throws NumberFormatException {
	// REMIND: this is inefficient
	this(valueOf(s).doubleValue());
    }

    /**
     * Returns true if this DoubleValueType value is the special Not-a-Number (NaN)
     * value.
     *
    ...
    /**
     * Returns true if this DoubleValueType value is infinitely large in magnitude.
     *
     * @return  <code>true</code> if the value represented by this object is
    ...
    /**
     * Returns the value of this DoubleValueType as a byte (by casting to a byte).
     *
     * @since   JDK1.1
     */
    ...
    /**
     * Returns the value of this DoubleValueType as a short (by casting to a short).
     *
     * @since   JDK1.1
     */
    ...
    /**
     * Returns the integer value of this DoubleValueType (by casting to an int).
     *
    ...
    /**
     * Returns the long value of this DoubleValueType (by casting to a long).
     *
     * @return  the <code>double</code> value represented by this object is
    ...
    /**
     * Returns the float value of this DoubleValueType.
     *
     * @return  the <code>double</code> value represented by this object is
    ...
    /**
     * Returns the double value of this DoubleValueType.
     *
    ...
    /**
     * Returns a hashcode for this <code>DoubleValueType</code> object. The result 
     ...
     * <code>double</code> value represented by this <code>DoubleValueType</code> 
     ...
     * <blockquote><pre>
     * long v = DoubleValueType.doubleToLongBits(this.doubleValue());
     * </pre></blockquote>
     *
     ...
     * not <code>null</code> and is a <code>DoubleValueType</code> object that 
     ...
     * <code>DoubleValueType</code>, <code>d1</code> and <code>d2</code>, the
     ...
     *     <code>DoubleValueType.NaN</code>, then the <code>equals</code> method
     *     returns <code>true</code>, even though
     *     <code>DoubleValueType.NaN==DoubleValueType.NaN</code> has the value
     *     <code>false</code>.
	...
	return (obj instanceof DoubleValueType)
	       && (doubleToLongBits(((DoubleValueType)obj).value) ==
     ...
     * <code>DoubleValueType.doubleToRawLongBits</code> method. 
     * <p>
     ...
     * <ul><li>
     *		<code>DoubleValueType.NaN</code> is considered by this method to be
     *		equal to itself and greater than all other double values
     *		(including <code>DoubleValueType.POSITIVE_INFINITY</code>).
     * <li>
     *		<code>0.0d</code> is considered by this method to be greater
     *		than <code>-0.0d</code>.
     * </ul>
     * This ensures that DoubleValueType.compareTo(Object) (which inherits its behavior
     ...
     *
     * @param   anotherDouble   the <code>DoubleValueType</code> to be compared.
     * @return  the value <code>0</code> if <code>anotherDouble</code> is
     *		numerically equal to this DoubleValueType; a value less than
     *          <code>0</code> if this DoubleValueType is numerically less than
     *		<code>anotherDouble</code>; and a value greater than
     *		<code>0</code> if this DoubleValueType is numerically greater than
     *		<code>anotherDouble</code>.
     *		
     * @since   1.2
     * @see     Comparable#compareTo(Object)
     */
    public int compareTo(DoubleValueType anotherDouble) {
        ...
        long thisBits = DoubleValueType.doubleToLongBits(thisVal);
        long anotherBits = DoubleValueType.doubleToLongBits(anotherVal);
    ...
    /**
     * Compares this DoubleValueType to another Object.  If the Object is a DoubleValueType,
     * this function behaves like <code>compareTo(DoubleValueType)</code>.  Otherwise,
     * it throws a <code>ClassCastException</code> (as Doubles are comparable
     * only to other Doubles).
     *
     * @param   o the <code>Object</code> to be compared.
     * @return  the value <code>0</code> if the argument is a DoubleValueType
     *		numerically equal to this DoubleValueType; a value less than
     *		<code>0</code> if the argument is a DoubleValueType numerically
     *		greater than this DoubleValueType; and a value greater than
     *		<code>0</code> if the argument is a DoubleValueType numerically
     *		less than this DoubleValueType.
     * @exception <code>ClassCastException</code> if the argument is not a
     *		  <code>DoubleValueType</code>.
     * @see     java.lang.Comparable
     * @since   1.2
     */
    public int compareTo(Object o) {
	return compareTo((DoubleValueType)o);
    }
